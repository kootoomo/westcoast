...
<head>
	...
	<link rel="preconnect" href="https://fonts.gstatic.com">
	<link href="https://fonts.googleapis.com/css2?family=Just+Another+Hand&Roboto:wght@100;300;400;500;700&display=swap" rel="stylesheet">
	<?php wp_head(); ?>
</head>
		...
		<nav id="main-nav" class="navbar navbar-expand-xl navbar-dark" aria-labelledby="main-nav-label">
			...
			<div class="container">	
				...
				<div class="search-input-holder">
					...
					<input type="text" id="header-product-autocomplete-input" onKeyUp="headerProductKeyup(this)" placeholder="Type your suburb here" />
				...
				<div class="col-lg-3">
					...
					<?php endif; ?>
						...
						<div class="meta-info">
							<div class="info">
								<div>
									<img src="<?php echo get_template_directory_uri(); ?>/img/home-trailer.svg" alt="Product Trailer" width="100%">
								</div>							
							...
							<div class="info">
								<div>
									<img src="<?php echo get_template_directory_uri(); ?>/img/home-bin.svg" alt="Product Bin" width="70%">
								</div>							
