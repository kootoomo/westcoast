...
<div class="wrapper" id="wrapper-footer">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="email"><i class="fa fa-envelope-o"></i> Email info@westcoast.com.au</div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="contact-form-holder">
                        <?php echo do_shortcode('[contact-form-7 id="22" title="Footer Contact Form"]'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="copyright">
        <div class="container">
        © Copyright West Coast Waste 2020 <span>//</span> <a href="#">Terms & Conditions</a> <span>//</span> <a href="https://moshi.com.au">Website by Moshi Moshi</a>
        </div>
    </div>
</div><!-- wrapper end -->
