...
function moshi_enqueue_scripts() {
    // wp_enqueue_style( 'easy-autocomplete', get_stylesheet_directory_uri() . '/css/easy-autocomplete.min.css' );
    // wp_enqueue_style( 'easy-autocomplete.themes', get_stylesheet_directory_uri() . '/css/easy-autocomplete.themes.min.css' );

    // wp_enqueue_script( 'jquery.easy-autocomplete', get_template_directory_uri() . '/js/jquery.easy-autocomplete.min.js', array(), '1.0.0', true );
